...
#include "../HOYLAND_KAUT_WALLACE/dll_export_def.h"
#include "random.h"
...
// input data
extern DLL_PUBLIC double InMom[13]; /// Input moments: 12 moments + InMom[0]:=1
extern DLL_PUBLIC double TgMom[4];  /// Target moments
