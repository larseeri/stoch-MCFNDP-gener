(Dec 11th 2025)
## SCENARIOS GENERATOR FOR THE LINEAR, TWO-STAGE,<br>MULTI-COMMODITY, FIXED CHARGE, CAPACITATED<br>NETWORK DESIGN PROBLEM WITH STOCHASTIC RECOURSE<br>
...
constructor in line 1114 of main.cpp is processed, provided it exists. This
...
docker run --rm --mount type=bind,src=absolutePathToDockerFolder/inout,dst=/inout stoch_gen_image /stoch_gen -h
docker run --rm --mount type=bind,src=absolutePathToDockerFolder/inout,dst=/inout stoch_gen_image /stoch_gen \
...
the container.
- The default configuration file /determ_config.par specified on line 1114
...
Docker instruction:
docker run --rm --mount type=bind,src=absolutePathToDockerFolder/inout,dst=/inout stoch_gen_image /stoch_gen +v \
